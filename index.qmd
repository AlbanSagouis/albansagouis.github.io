...
8.  I co-maintain [`mobsim`](https://github.com/MoBiodiv/mobsim), a community simulation R package that we use for work, for [teaching](https://github.com/chase-lab/biodiv-patterns-course-2024/tree/main/week%202/3%20-%20Wednesday) and publish on [CRAN](https://cran.r-project.org/package=mobsim)
