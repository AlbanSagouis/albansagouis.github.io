...
A couple of weekend projects ideas turned into packages: APMD and stopmotion,
both published on CRAN. [`APMD`](https://github.com/albansagouis/APMD) or Analog Photography MetaData inserts metadata
in scanned analog photographs. [`stopmotion`](https://cran.r-project.org/package=stopmotion) gives R functions to modify and
edit together pictures to create a stopmotion animation.
