...
image: /assets/images/tech-news-6/boxplot.gif
categories:
...
![Animated boxplot of miles per gallon by number of cylinders from the mtcars dataset, transitioning across gear values](/assets/images/tech-news-6/boxplot.gif)
...
![Animated scatter plot of GDP per capita versus life expectancy by continent from 1952 to 2007, bubble size proportional to population, created with gganimate and gapminder data](/assets/images/tech-news-6/scatterplot.gif)
...
![Animated map of California counties showing simulated data points coloured by temperature, transitioning year by year from 1990 to 2019](/assets/images/tech-news-6/map.gif)
