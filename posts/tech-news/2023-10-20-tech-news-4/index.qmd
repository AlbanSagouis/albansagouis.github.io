...
image: /assets/images/tech-news-4/fig1.png
toc-depth: 4
categories:
  - experience
  - R
...
![Screenshot comparing broom::tidy() and base::summary() output for an R model, showing the cleaner tabular layout produced by broom](/assets/images/tech-news-4/fig1.png)
...
![Screenshot of a flextable table: New York Air Quality Measurements with Air quality and Time column groups, styled with the vanilla theme](/assets/images/tech-news-4/fig2.png)
...
<video autoplay loop muted playsinline style="max-width:100%">
  <source src="/assets/images/tech-news-4/fig3.mp4" type="video/mp4">
</video>
...
![Screenshot of a gt table showing S&P 500 daily data from June 7–14, 2010, with formatted currency values, dates, and trading volume](/assets/images/tech-news-4/fig4.png)
...
<video autoplay loop muted playsinline style="max-width:100%">
  <source src="/assets/images/tech-news-4/giphy.mp4" type="video/mp4">
</video>
